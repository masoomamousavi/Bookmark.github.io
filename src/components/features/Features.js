    ...
    return (
        < section id="features">
            <div className="container mx-auto mt-24">
                <h1 className="font-semibold text-2xl lg:text-4xl text-center py-3">Features</h1>
                <p className=" font-normal text-lg text-grayishBlue text-center max-w-md mx-auto">Our aim is to make it quick and easy for you to access your favourite websites. Your bookmarks sync between your devices so you can access them on the go</p>
                {/* Feature Items Part */}
                <div className="container mx-auto relative my-6 mt-12 px-6">
                    ...
                    <div className="flex flex-col justify-center max-w-2xl border-b mx-auto mb-6 md:space-x-10 md:flex-row">
                        {/* first feature */}
                        <div className="border-gray-300 cursor-pointer bordr-b  justify-center text-center text-gray-600 md:border-b-0 m flex md:w-1/3" onClick={() => tabHandler(1)} >
                            <div className={`text-xl py-5  hover:text-softRed text-gray-800 ${activate === 1 ? `border-b-4 border-softRed` : ''}`}>Simple Bookmarking</div>
                        </div>
                        {/* second feature */}
                        <div className='border-gray-300 cursor-pointer justify-center text-center text-gray-600  md:border-b-0 m flex md:w-1/3' onClick={() => tabHandler(2)} id="div2">
                            <div className={`text-xl py-5  hover:text-softRed text-gray-800 ${activate === 2 ? `border-b-4 border-softRed` : ''}`}>Speedy Searching</div>
                        </div>
                        {/* third feature */}
                        <div className='border-gray-300 cursor-pointer justify-center text-center text-gray-600 md:border-b-0 m flex md:w-1/3' onClick={() => tabHandler(3)} >
                            <div className={`text-xl py-5  hover:text-softRed text-gray-800 ${activate === 3 ? `border-b-4 border-softRed` : ''}`}>Easy Sharing</div>
                        </div>
                    </div>
                </div>
            </div>
