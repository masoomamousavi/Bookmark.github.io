    ...
    return (
        <div className="container flex pb-32 flex-col mx-auto py-3 pt-7 lg:flex-row lg:mb-0">
            ...
            <div className="flex flex-col lg:space-y-10 space-y-6 mt-10 lg:mt-0 lg:pl-5 lg:w-1/2">
                <h1 className="text-2xl md:text-3xl font-semibold text-center lg:text-left lg:text-4xl">{feature.title}</h1>
                <p className="max-w-md mx-auto text-base md:text-lg text-center text-grayishBlue lg:text-xl lg:text-left lg:mt-0 lg:ml-0">{feature.descript}</p>
