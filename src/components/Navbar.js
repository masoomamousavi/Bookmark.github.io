...
export function Navbar1() {
    return (
        ...
        //     <div className="flex space-x-20 items-center justify-between my-3">
        ...
        //         </div>
        //         <div className="hidden items-center uppercase space-x-10 md:flex text-grayishBlue">
        //             <a href="#features" className='tracking-widest hover:text-softRed text-md'>features</a>
        //             <a href="#download" className='tracking-widest hover:text-softRed text-md'>Download</a>
        //             <a href="#faq" className='tracking-widest hover:text-softRed'>faq</a>
        //             <a className='tracking-widest hover:cursor-pointer bg-softRed px-8 py-2 text-md text-white border-2 border-softRed rounded-lg text-md shadow-md hover:text-softRed hover:bg-white'>Login</a>
        //         </div>
        //     </div>
        // </div>
        <div className="navbar bg-base-100">
            ...
            <div className="lg:navbar-start navbar-end w-full">
                <div className="dropdown relative">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content absolute z-[50] p-2 -mt-3 shadow bg-base-100 rounded-box w-52" style={{ left: '-280%' }}>
